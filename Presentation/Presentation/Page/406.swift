...
struct Page406Page: Page {
    ...
    func cunningText(step: Int) -> String {
        """
        おおーなんと見てください。すごいですね。このHitchesのところめちゃくちゃ綺麗になりました。これは良いんじゃないでしょうか。
        ...
        ゲーミングディスプレイとか、僕はあんまり詳しくないですけど、2msとか5msのレベルで遅延がどうこう言ってるじゃないですか。そんな中でこのアプリは16msも遅延してるんですよね。やばくないですか。使ってらんないですよね。
